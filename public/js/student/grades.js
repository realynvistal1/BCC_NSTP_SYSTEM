document.addEventListener('DOMContentLoaded',()=>bootstrapPortalPage({
  expectedPortal:'student',shellRole:'student',moduleSrc:'/assets/js/student/_pages.js',render:async(content)=>{
    ...
    content.innerHTML=`<section class="panel student-grade-panel"><div class="table-wrap"><table class="old-table student-grade-table"><thead><tr><th>Subject</th><th>Description</th><th>Midterm</th><th>Final Term</th><th>Average</th><th>Unit</th><th>Status</th></tr></thead><tbody>${tr('NSTP 1',ms1)}${tr('NSTP 2',ms2)}</tbody></table></div></section>`;
  }
}));
